            ...
            <form className="flex flex-col gap-6">
                <div className="flex flex-col gap-2 text-[#1a2a4a]">
                    ...
                    <input 
                        ...
                        className="px-4 py-3 border border-[#e2e8f0] rounded-lg text-base transition-all duration-300 focus:outline-none focus:border-[#4dabf7] focus:shadow-[0_0_0_3px_rgba(77,171,247,0.2)]"
                    />
                </div>
                <div className="flex flex-col gap-2 text-[#1a2a4a]">
                ...
                <button type="submit" className="bg-linear-to-r from-blue-500 to-sky-400 text-white border-none p-3 rounded-lg font-semibold text-base cursor-pointer transition-all duration-300 mt-4 hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(59,130,246,0.3)]">Enviar Avaliação</button>
            </form>
        </div>
    );
};
